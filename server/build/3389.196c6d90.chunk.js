"use strict";(self.webpackChunkserver=self.webpackChunkserver||[]).push([[3389],{40216:(rt,U,s)=>{s.d(U,{S:()=>$});var t=s(92132),_=s(79793),p=s(94061),X=s(48653),E=s(83997),S=s(30893);const F=(0,_.Ay)(p.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
